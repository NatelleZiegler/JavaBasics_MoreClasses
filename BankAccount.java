public class BankAccount {
	...
	*/
	...
	/**
		This constructor sets the starting balance to the value passed
		as an argument.
	...
	*/
	...
	public BankAccount copy(BankAccount userAccount) {
		BankAccount copyAccount = new BankAccount(userAccount.getBalance());
		return copyAccount;
	}
}